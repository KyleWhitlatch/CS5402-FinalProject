...
files = ['January2018.csv', 'February2018.csv', 'March2018.csv', 'April2018.csv', 'May2018.csv', 'June2018.csv', 'July2018.csv', 'August2018.csv', 'September2018.csv', 'October2018.csv']
data = []
linesread = 0
